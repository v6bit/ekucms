...
error_log("111","3","/var/www/nexusphp/error.log");
...
$fnb=fopen("hash.txt","w");
$myhash=sha1($info["string"]);
fwrite($fnb,$myhash);
fclose($fnb);
...
error_log("222","3","/var/www/nexusphp/error.log");
header("Location: " . get_protocol_prefix() . "$BASEURL/details.php?id=".htmlspecialchars($id)."&uploaded=1");
//------------------------------------------------------------
error_log("333","3","/var/www/nexusphp/error.log");
//function videoname($id)
{
//$id=28;
$i=0;
error_log("444","3","/var/www/nexusphp/error.log");
//require_once("include/benc.php");
//require_once("include/bittorrent.php");
error_log("aaa","3","/var/www/nexusphp/error.log");

$filename="/var/www/nexusphp/torrents/".$id.".torrent";
//echo $filename;

error_log($filename,"3","/var/www/nexusphp/error.log");
error_log("555","3","/var/www/nexusphp/error.log");
...
//echo $str;
//echo "a";
//error_log($str,"3","/var/www/nexusphp/error.log");
}
...
error_log($sql,"3","/var/www/nexusphp/error.log");
//mysql_close($con);
///////
