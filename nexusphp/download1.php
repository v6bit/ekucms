...
$announce_urls1="tracker.6xvod.com:6969/announce";
{
	$dict['value']['announce-list']['type'] = "list";
	$dict['value']['announce-list']['value'][0]['type'] = "list";
	$dict['value']['announce-list']['value'][0]['value'][0]["type"] = "string";
	$dict['value']['announce-list']['value'][0]['value'][0]["value"] = $ssl_torrent . $base_announce_url . "?passkey=$CURUSER[passkey]";
	...
	$dict['value']['announce-list']['value'][1]['value'][0]["value"] = $ssl_torrent . $announce_urls1 . "?passkey=$CURUSER[passkey]";
...
$a=date("Y-m-d H:i:s");
$date_utc=strtotime($a);
$u_ip=$_SERVER["REMOTE_ADDR"];

mysql_select_db("ekucms");
$sql="insert into eku122x_player (u_id,v_id,date_utc,u_ip) VALUES ('$passkey','$id','$date_utc','$u_ip')";
