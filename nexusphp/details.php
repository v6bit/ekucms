...
$sql="select bean from torrents where id='$id'";
$bean=mysql_query($sql);
while($row1=mysql_fetch_array($bean))
{
$bean=$row1['bean'];
}
//------------------
?>
<script>document.getElementById('doubanid').value="<?php echo $bean; ?>"</script>
<?php
