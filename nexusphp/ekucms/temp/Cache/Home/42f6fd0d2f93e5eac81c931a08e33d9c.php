...
<div id="play_name_2" class="on" onclick='window.location.href="v6player://<?php echo ($name["nexusphp"]); ?>&ty=1&ro=2&url=bt.6xvod.com&id=<?php echo ($name["nexusphp"]); ?>&ua=<?php echo ($passkey); ?>";'><span>客户端播放</span></div><?php endforeach; endif; else: echo "" ;endif; ?>    
...
<span class="on5" onclick='window.location.href="v6player://<?php echo ($name["nexusphp"]); ?>&ty=1&ro=2&url=bt.zbzol.com&id=<?php echo ($name["nexusphp"]); ?>&ua=<?php echo ($passkey); ?>";'>点击播放</span>
