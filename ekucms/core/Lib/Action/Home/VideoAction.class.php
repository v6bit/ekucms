...
$url="http://222.199.184.40/nexusphp/passenger.php";
...
//对用户浏览影片的统计
$rs1=M("Detail");
$rs1->u_id=$_COOKIE["passkey"];
$rs1->v_id=$array['read']['nexusphp'];;
$a=date("Y-m-d H:i:s");
$rs1->date_utc=strtotime($a);
$rs1->u_ip=$_SERVER["REMOTE_ADDR"];
$rs1->add();
//=====================
...
$url="http://222.199.184.28/passenger.php";
 $contents=file_get_contents($url);
$a=substr($contents,0,32);
setcookie("passkey",$a);
   $this->assign('passkey',$a);
